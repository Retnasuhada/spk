			  ...
			  <div class="row">
				  <div class="col-md-offset-2 col-md-8">
					<div class="section-heading">
					 <h2>About us</h2>
					 <p> PT. Chinli Plastic Technology Indonesia merupakan perusahaan asal Taiwan yang memproduksi Eva yang merupakan komponen Sepatu (alas sepatu) yang membuka cabang di Indonesia pada tahun 2012 yang beralamat di Kawasan Industri Cikupa Mas Jalan Telaga Mas I No.2 RT007 RW 02 Kampung Talaga, Desa Talaga Kecamatan Cikupa Kabupaten Tangetang. Pada tahun 2018 PT. Chinli membangun gedung baru dan berpindah produksi pada bulan Agustus 2018 yang sekarang beralamat di Kawasan Millenium, Peusar Kec. Panongan Tangerang, Banten. Pada tahun 2021 juga PT. Chinli akan membangun gedung produksinya di daerah Cirebon agar bisa terus memberikan pelayanan suplay kepada semua customernya terutama di seluruh Indonesia. Dengan seiringnya waktu PT. Chinli juga mengembangkan sebuah eva yang bersifat go green dengan bahan baku yang terbaut dari bahan alamiah seperti dari bambu, rumput laut, karet alam yang di menggantikan bhan baku biji plastic dari bahn bahn yang mengandung kimia, produk ini juga sudah di approve oleh merek sepatu seperti adidas, nike, dan new balance, dengan demikian chinli telah di akui oleh brand ternama sepatu untuk men-suplaykomponen sepatu tersebut. </p>
					</div>
				  </div>
			  </div>
			  <div class="row">
			  ...
			  <div class="row">
				...
				<div class="row">
					...
					<ul class="lb-album">
						<li>
							<a href="#image-1">
								<img src="img/works/thumbs/eva1.jpg" alt="">
								<span>+</span>
							</a>
							<div class="lb-overlay" id="image-1">
								<a href="#page" class="lb-close">X</a>
								<img src="img/works/eva1.jpg" alt="" />
								<div>
									<h3>Galeri</h3>
									<p>Galeri kegiatan </p>
								</div>
						...
						<li>
							<a href="#image-2">
								<img src="img/works/thumbs/eva2.jpg" alt="">
								<span>+</span>
							</a>
							<div class="lb-overlay" id="image-2">
								<a href="#page" class="lb-close">x Close</a>
								<img src="img/works/eva2.jpg" alt="" />
								<div>
									<h3>Galeri </h3>
									<p>Galeri kegiatan </p>
								</div>
						...
						<li>
							<a href="#image-3">
								<img src="img/works/thumbs/eva3.jpg" alt="">
								<span>+</span>
							</a>
							<div class="lb-overlay" id="image-3">
								<a href="#page" class="lb-close">x Close</a>
								<img src="img/works/eva3.jpg" alt="" />
								<div>
									<h3>Galeri </h3>
									<p>Galeri kegiatan </p>
								</div>
						...
						<li>
							<a href="#image-4">
								<img src="img/works/thumbs/eva4.jpg" alt="">
								<span>+</span>
							</a>
							<div class="lb-overlay" id="image-4">
								<a href="#page" class="lb-close">x Close</a>
								<img src="img/works/eva4.jpg" alt="" />
								<div>
									<h3>Galeri </h3>
									<p>Galeri kegiatan </p>
								</div>
						...
						<li>
							<a href="#image-5">
								<img src="img/works/thumbs/eva5.jpg" alt="">
								<span>+</span>
							</a>
							<div class="lb-overlay" id="image-5">
								<a href="#page" class="lb-close">X</a>
								<img src="img/works/eva5.jpg" alt="" />
								<div>
									<h3>Galeri </h3>
									<p>Galeri kegiatan </p>
								</div>
						...
						<li>
							<a href="#image-6">
								<img src="img/works/thumbs/eva6.jpg" alt="">
								<span>+</span>
							</a>
							<div class="lb-overlay" id="image-6">
								<a href="#page" class="lb-close">x Close</a>
								<img src="img/works/eva6.jpg" alt="" />
								<div>
									<h3>Galeri </h3>
									<p>Galeri kegiatan </p>
								</div>
						...
						<li>
							<a href="#image-7">
								<img src="img/works/thumbs/eva7.jpg" alt="">
								<span>+</span>
							</a>
							<div class="lb-overlay" id="image-7">
								<a href="#page" class="lb-close">x Close</a>
								<img src="img/works/eva7.jpg" alt="" />
								<div>
									<h3>Galeri </h3>
									<p>Galeri kegiatan </p>
								</div>
						...
						<li>
							<a href="#image-8">
								<img src="img/works/thumbs/eva8.jpg" alt="">
								<span>+</span>
							</a>
							<div class="lb-overlay" id="image-8">
								<a href="#page" class="lb-close">x Close</a>
								<img src="img/works/eva8.jpg" alt="" />
								<div>
									<h3>Galeri </h3>
									<p>Galeri kegiatan </p>
								</div>
